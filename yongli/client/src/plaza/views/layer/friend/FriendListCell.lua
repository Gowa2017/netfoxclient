...
function FriendListCell:createCell(userInfo,index,contentView,superView)
    ...
    local nickName = ClipText:createClipText(cc.size(150,30), userInfo.szNickName, "base/fonts/round_body.ttf", 30)
    ...
    local userStatusLab = ClipText:createClipText(cc.size(350,25), "", "base/fonts/round_body.ttf", 25)
