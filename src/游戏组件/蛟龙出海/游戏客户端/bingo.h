...
class Bingo {
 public:
  ...
  void SetBingoInfo(WORD chair_id, SCORE fish_score, bool bcaijin=false);
 ...
 private:
  ...
  void RenderCaijin(WORD chair_id, float x, float y, float rot, float hscale, float vscale);
 private:
  hgeAnimation* spr_bingo_num_[GAME_PLAYER];
  hgeAnimation* spr_bingo_caijin_[GAME_PLAYER];
