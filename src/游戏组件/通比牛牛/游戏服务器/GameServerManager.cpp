...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME  TEXT("OxTobiNewAndroid.dll")  //组件名字
#else
#define ANDROID_SERVICE_DLL_NAME  TEXT("OxTobiNewAndroid.dll")  //组件名字
#endif
...
CGameServiceManager::CGameServiceManager(void)
{
  ...
  lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("OxTobiNew.exe"),CountArray(m_GameServiceAttrib.szClientEXEName));
  lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("OxTobiNewServer.dll"),CountArray(m_GameServiceAttrib.szServerDLLName));
