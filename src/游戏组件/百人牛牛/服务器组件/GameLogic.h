...
public:
  ...
  //混乱扑克
  void RandCardListLose(BYTE cbCardBuffer[], BYTE cbBufferCount,BYTE cbAllCardData[54],BYTE cbCardCount);
  //删除牌
  bool RemoveGoodCardData(BYTE cbGoodcardData[5], BYTE cbGoodCardCount, BYTE cbCardData[54], BYTE cbCardCount) ;
};
