...
bool CTableFrameSink::OnUserPlayBet(WORD wChairID, BYTE cbBetArea, SCORE lBetScore)
{
	...
	if (bPlaceBetSuccess)
	{
		...
		PlaceBet.lAreaAllJetton = m_lPlayBet[wChairID][cbBetArea];
		//已下注额
		LONGLONG lNowBet = 0l;
		for (int nAreaIndex = 0; nAreaIndex < AREA_MAX; ++nAreaIndex ) 
...
bool CTableFrameSink::DispatchTableCard()
{
	...
	//m_cbTableCardArray[0][0] = 0x02;
	//m_cbTableCardArray[0][1] = 0x01;
	//m_cbTableCardArray[0][2] = 0x03;

	//m_cbTableCardArray[1][0] = 0x16;
	//m_cbTableCardArray[1][1] = 0x11;
	//m_cbTableCardArray[1][2] = 0x31;
	//首次发牌
