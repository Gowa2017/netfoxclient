...
bool CServiceUnits::RectifyServiceParameter()
{
	...
	{
		CTraceService::TraceString(m_GameServiceManager.m_szModuleDllName, TraceLevel_Exception);
		CTraceService::TraceString(m_GameServiceAttrib.szServerDLLName, TraceLevel_Exception);
