...
--测试
yl.LOGONSERVER							= "127.0.0.1" --@login_ip
-- 登陆地址列表
yl.SERVER_LIST = 						{ "127.0.0.1", } --@login_ip 
-- 当前地址索引
yl.CURRENT_INDEX = 1
...
yl.FRIENDPORT							= 8630 --@friend_port
--编译码
yl.VALIDATE 							= "18E9E77D-C628-4FD6-AC60-98A541DBD5C1" --@compilation

--http请求链接地址
yl.HTTP_URL								= "http://28xin.com" --@http_url
