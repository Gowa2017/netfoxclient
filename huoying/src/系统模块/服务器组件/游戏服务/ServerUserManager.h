...
public:
	...
	//设置控制
	virtual VOID SetZhaJinHuaGameRate(int bGameRate){ m_nZhaJinHuaGameRate=bGameRate; }
	//设置控制
	virtual int GetZhaJinHuaGameRate(){return m_nZhaJinHuaGameRate; }
	//设置控制
