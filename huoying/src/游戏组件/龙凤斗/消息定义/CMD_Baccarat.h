...
#define KIND_ID						133									//游戏 I D
#define GAME_NAME					TEXT("龙凤斗")						//游戏名字
...
//玩家索引
#define AREA_LONG					0									//龙
#define AREA_PING					1									//和
#define AREA_FENG					2									//凤

#define AREA_MAX					3									//最大区域

//区域倍数multiple
#define MULTIPLE_LONG					2									//龙
#define MULTIPLE_PING					10									//和
#define MULTIPLE_FENG					2									//凤
...
struct CMD_S_StatusPlay
{
	...
	BYTE							cbTableCardArray[2][1];				//桌面扑克
