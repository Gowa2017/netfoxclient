...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("LongFengDou.exe"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("LongFengDouServer.dll"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
VOID * CGameServiceManager::CreateAndroidUserItemSink(REFGUID Guid, DWORD dwQueryVer)
{
	try
	{
		...
		{
			m_AndroidServiceHelper.SetModuleCreateInfo(TEXT("LongFengDouAndroid.dll"),"CreateGameServiceManager");
...
HWND CGameServiceManager::CreateCustomRule( CWnd * pParentWnd, CRect rcCreate, LPBYTE pcbCustomRule, WORD wCustonSize )
{
	...
	hDllInstance = AfxLoadLibrary(TEXT("LongFengDouAndroid.dll"));
