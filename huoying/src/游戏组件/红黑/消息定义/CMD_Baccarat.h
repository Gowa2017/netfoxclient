...
#define KIND_ID						211									//游戏 I D
#define GAME_NAME					TEXT("红黑")						//游戏名字
...
#define AREA_WIN_MAX				8									//结算最大区域
#define AREA_CONTROL_MAX			9									//控制最大区域
#define AREA_SPECIAL_INDEX			1									//投注特殊区域

//区域倍数multiple
#define MULTIPLE_BLACK					2									//黑方倍数
#define MULTIPLE_ADD					0									//额外倍数
#define MULTIPLE_RED					2									//红方倍数
#define MULTIPLE_BAOZI					15									//豹子倍数
#define MULTIPLE_TONGHUASHUN			10									//同花顺倍数
#define MULTIPLE_JINHUA					4									//金花倍数
#define MULTIPLE_SHUNZI					3									//顺子倍数
#define MULTIPLE_DUIZI					2									//对子倍数
...
struct CMD_S_StatusPlay
{
	...
	//SCORE							lPlayerBet[AREA_MAX];					//真人总下注
	//SCORE							lAndroidBet[AREA_MAX];					//机器人总下注
	//SCORE							lPlayerAreaBet[GAME_PLAYER][AREA_MAX];	//真人玩家每个区域下注
	//DWORD							dwGameID[GAME_PLAYER];					//玩家id
	//SCORE							lPlayerTotleBet[GAME_PLAYER];			//每个玩家总下注
